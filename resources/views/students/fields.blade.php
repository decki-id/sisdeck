...
<div class="row">
    <div class="form-group col-sm-6">
        ...
        {!! Form::text('guardian_name', null, ['class' => 'form-control','maxlength' => 191,'maxlength' => 191]) !!}
    </div>
    <div class="form-group col-sm-6">
        {!! Form::label('guardian_relation', 'Guardian Relation') !!}
        {!! Form::text('guardian_relation', null, ['class' => 'form-control','maxlength' => 191,'maxlength' => 191]) !!}
    </div>
</div>
<div class="row">
    <div class="form-group col-sm-12">
        {!! Form::label('guardian_phone', 'Guardian Phone') !!}
        {!! Form::text('guardian_phone', null, ['class' => 'form-control','maxlength' => 191,'maxlength' => 191]) !!}
    </div>
</div>
<div class="row">
    <div class="form-group col-sm-6">
...
<a href="{{ route('sisdeck.students.index') }}" class="btn btn-default">Cancel</a>